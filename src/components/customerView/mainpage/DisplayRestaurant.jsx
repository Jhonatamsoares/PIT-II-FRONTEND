  ...
  render() {
    return this.props.currentUser && this.state.restaurant ? (
      <div>
        ...
        <i><b>Bem-vindo ao {this.state.restaurant.information.restaurantName}</b></i>
        </Typography>
        {!this.state.restaurant.information.open ? (
          <Typography variant="body1" color="error">Fechado, voltarei em breve...</Typography>
        ) : null}
        <br />
        ...
        <div className="checkoutBox">
          <Grid container justify="flex-end">
              <Grid item>
                <Typography variant="h5"><i>Subtotal : R$ {this.state.subtotal}</i></Typography>
              </Grid>
          </Grid>
          <br />
          <Grid container justify="flex-end">
    ...
    ) : <div>Que pena, hoje não estamos disponível</div>
  }
}
