          ...
          <Collapse in={this.state.expanded} timeout="auto" unmountOnExit>
            <CardContent>
              ...
              {this.props.order.endTime !== null ? (
                <Typography paragraph><i>Pedido já chegou em {new Date(Date.parse(this.props.order.endTime)).toLocaleString()}</i></Typography>
              ) : null}
              {this.props.order.startTime !== null && this.props.order.delivery && this.state.wrongAddress ? <Typography variant="body1" color="secondary">O endereço não pode ser carregado, entre em contato com o motorista para obter informações detalhadas sobre a rota</Typography> : null}
              ...
              {this.props.userType === "customer" && this.props.order.endTime !== null && this.props.order.comment === null ? (
                <Box component="fieldset" mb={3} borderColor="transparent">
                  ...
                  <TextField
                    ...
                    required
                    fullWidth
                    label="Por favor, adicione seu comentário"
                    type="text"
